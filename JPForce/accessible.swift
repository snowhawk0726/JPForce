...
protocol Accessible {
    ...
    func access(by accessor: JpfObject, with environment: Environment) -> JpfObject?
}
extension JpfObject {
...
extension JpfArray : Accessible {
    func access(by accessor: JpfObject, with environment: Environment) -> (any JpfObject)? {
        switch accessor {
...
extension JpfString : Accessible {
    func access(by accessor: any JpfObject, with environment: Environment) -> (any JpfObject)? {
        switch accessor {
