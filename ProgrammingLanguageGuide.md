...
`数値`,`文字列`,`真偽値`,`無`,`エラー`以外の型では、以下の様な形式で定義することが可能です。
...
```
形式１：関数【(入力が、<入力定義>。)(出力が、<出力定義>。)(本体が、)<実行処理>】
形式２：関数であって、(入力が、<入力定義>。)(出力が、<出力定義>。)(本体が、)<実行処理>。
```
...
形式２：算出であって、(入力が、<入力定義>。)(出力が、<出力定義>。)(本体が、)<実行処理>
```
...
形式３：
  ...
  】。
形式４：算出であって、設定が、【(入力が、<入力定義>。)(出力が、<出力定義>。)(本体が、)<実行処理>】。取得が、【(入力が、<入力定義>。)(出力が、<出力定義>。)(本体が、)<実行処理>。】。
```
