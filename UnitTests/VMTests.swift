...
final class VMTests: XCTestCase {
    ...
    func testConditionals() throws {
        let testPattern: [VmTestCase] = [
            ...
            ("１が２より大きい場合、【10】", nil),
            ("偽である場合、【10】。", nil),
            ("１が２より大きい場合【10】である場合【20】", "「ある」で評価すべき値が空です。"),
            // VM
            ("真で。ある場合、【10】。", 10),
            ...
            ("１が２より大きい。場合【10】", nil),
            ("無で。ある場合【10】", nil),
            ("１が２より大きい。場合【10】である場合【20】", "「ある」で評価すべき値が空です。"),
        ]
        try runVmTests(with: testPattern)
    }
    ...
    func testCallingFuntionsWithWrongArguments() throws {
        let testPattern: [VmTestCase] = [
            ...
            ("関数【入力がa。a】を実行。", "入力の数が足りません。必要数：1"),
            ("１で関数【入力がaとb。aとbを足す】を実行。", "入力の数が足りません。必要数：2"),
        ]
        try runVmTests(with: testPattern)
    }
    func testBuiltinFunctions() throws {
        let testPattern: [VmTestCase] = [
            ...
            ("１。最初", "1(数値)を「最初」でアクセスすることはできません。"),
            ("配列【１、２、３】の最後", 3), ("配列【】の末尾", nil),
            ("配列【１、２、３】。最後", 3), ("配列【】。末尾", nil),
            ("１。最後", "1(数値)を「最後」でアクセスすることはできません。"),
    ...
    func testAssignOperations() throws {
        let testPattern: [VmTestCase] = [
            // 定数計算
            ("配列【1,2,3】の1に0を代入する。", [1,0,3]),
            ("0を、配列【1,2,3】の1に代入する。", [1,0,3]),
            ("辞書【1が真,2が偽】の1に0を代入する。それの1", 0),
            ("2から2を引き、辞書【1が真,2が偽】の1に代入する。それの1", 0),
            // 単純代入
            ("aに1を代入する。a。", 1),
            ("２をaに代入する。a", 2),
            ("aは2。aに3を代入する。a。", 3),
            ...
            ("aに、1を代入し、7を足して代入する。a。", "複合代入文では、文末以外に代入を書くとことができません。(解析位置: 代入)"),
            // 要素代入
            ("iは1。配列【1,2,3】のiに0を代入する。",[1,0,3]),
            ("vは0。配列【1,2,3】の1にvを代入する。",[1,0,3]),
            ("iは1。vは0。配列【1,2,3】のiにvを代入する。",[1,0,3]),
            ("aは配列【1,2,3】。iは1。vは0。aのiにvを代入する。a。",[1,0,3]),
            ("""
              a1は配列【1,2,3】。a2は配列【1,a1,3】。iは1。vは0。
              a2のiのiにvを代入する。(「a2のi」はa1)
            """,[1,0,3]),
            ("""
              a1は配列【1,2,3】。a2は配列【1,a1,3】。iは1。vは0。
              vをa2のiのiに代入する。(「a2のi」はa1)
            """,[1,0,3]),
            ("""
              a1は配列【1,0,3】。a2は配列【1,a1,3】。iは1。
              a2のiにa1のiを代入する。a2。
            """,[1,0,3]),
            ("""
              a1は配列【1,0,3】。a2は配列【1,a1,3】。iは1。
              a1のiをa2のiに代入する。a2。
            """,[1,0,3]),
            // Programming Language Guide 例文
            ("xは１。xに1を足して代入。x。",2),
            ("xは１。xから1を引いて代入。x。",0),
            ("xは１。xを3から引いて代入。x。",2),
            ("xは２。xで6を割って代入。x。",3),
            ("xは１。xを負数にして代入。x。",-1),
            ("xは配列【１、２】。xに３を追加して代入。x。",[1,2,3]),
            ("xは辞書【「い」が1、「ろ」が2】。xの「い」を削除して代入。xの「ろ」。",2),
