...
final class EvaluatorTests: XCTestCase {
    ...
    func testOuterIdentifiers() throws {
        let testPatterns: [(input: String, expected: Any?)] = [
            ...
            ("甲は配列【１、２、３】。乙は１。関数【甲は１。外部「甲」の位置『乙』に０を代入】を実行。甲。", [1,0,3]),
            ("甲は配列【１、２、３】。乙は２。関数【乙は１。外部「甲」の位置『外部「乙」』に０を代入】を実行。甲。", [1,2,0]),
            ("甲は配列【１、２、３】。乙は２。関数【乙は１。外部「甲」の位置「外部『乙』」に０を代入】を実行。甲。", [1,2,0]),
    ...
    func testAssignToContainers() throws {
        let testPatterns: [(input: String, expected: Any?)] = [
            ...
            ("配列【１、２、３】の位置「１」に５を代入したものの１。", 5),
            ("甲は、配列【１、２、３】。乙は０。甲の位置『乙』に５を代入する。甲の最初", 5),
            ("甲は、配列【１、２、３】。関数【５を甲の位置２に代入する。】を実行する。甲の最後", 5),
            ("甲は、配列【１、２、３】。乙は２。関数【５を甲の位置『乙』に代入する。】を実行する。甲の最後", 5),
            // 辞書への代入
            ("辞書【1が「一」、2が「二」、3が「三」】のキー2に「弍」を代入したものの2の値","弍"),
            ("辞書【1が「一」、2が「二」、3が「三」】のキー4に「四」を代入したものの4の値","四"),
            ("甲は、辞書【「い」が「一」、「ろ」が「二」、「は」が「三」】。甲のキー「は」に「参」を代入する。甲の「は」の値", "参"),
            ("甲は、辞書【真が1、偽が0】。甲のキー偽に2を代入する。甲の偽の値",2),
            ("甲は、辞書【1が「一」、2が「二」、3が「三」】。乙は２。関数【「弍」を甲のキー『乙』に代入する。】を実行する。甲の2の値", "弍"),
            // <配列>の<位置>は、<値>
