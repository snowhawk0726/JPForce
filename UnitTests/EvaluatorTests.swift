...
final class EvaluatorTests: XCTestCase {
    ...
    func testBuiltinFunctions() throws {
        let testPatterns: [(input: String, exptected: Any)] = [
            ...
            ("辞書【「あ」が１、「い」が２、「う」が30】が、関数【入力がキーと値で、値が10より大きい】を含む", true),
            // 並べ替える
            ...
            ("辞書【１が「１」、２が「２」、３が「３」、４が「４」、５が「５」】を、関数【入力がキーと値で、キー】で写像し、並べ替える。", [1,2,3,4,5]),
            ...
            ("辞書【「あ」が１、「い」が２、「う」が30】を、関数【入力がキーと値で、値が10より大きい】で絞り込み、関数【入力がキーと値で、値】で写像する。", [30]),
            // 逆順にする
