...
final class LexerTests: XCTestCase {
   ...
   func testNextToken() throws {
        ...
        let testPatterns: [(expectedType: Token, expectedLiteral: String)] = [
            ...
            (.STRING(),"こんにちは "),(Token(.EOL),"\n"), (.STRING(),"今日は、みなさん。"),(Token(.EOL),"\n"),            (Token(.INPUT),"入力"),(Token(.GA),"が"),(Token(.COMMA),"、"),(.INT(),"10"),(Token(.UNDER),"未満"),(Token(.NO),"の"),(Token(.CASE),"場合"),(Token(.COMMA),"、"),(Token(.TRUE),"真"),(Token(.WO),"を"),(Token(keyword: .RETURN),"返し"),(Token(.COMMA),"、"),(Token(.ELSE),"それ以外"),(Token(.WA),"は"),(Token(.COMMA),"、"),(Token(.FALSE),"偽"),(Token(.WO),"を"),(Token(keyword: .RETURN),"返す"),(Token(.PERIOD),"。"),(Token(.EOL),"\n"),
